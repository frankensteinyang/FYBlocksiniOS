...
#define FYCalendarCell_LB_FONT_SIZE (15.f) // lb的默认字号
...
#define FYCalendarCell_DAY_COLOR ([UIColor blackColor]) // 日期有价格数据时的字体颜色
...
#define FYCalendarCell_DATE_CELL_BACKGROUND_COLOR ([[UIColor greenColor] colorWithAlphaComponent:.3f]) // 只有日期的cell的背景颜色
